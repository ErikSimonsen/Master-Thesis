...
\newglossaryentry{hdrHistogramm}{
  ...
  description={Histogramme die das Aufnehmen und Analysieren von
      ausgewählten Daten über eine konfigurierbare, ganzzahlige Reichweite und eine definierbare
...
\newglossaryentry{jpag}{
  ...
  description={
      ...
      relationale Datenbank erleichtert, um sie dort zu persistieren.
...
\newglossaryentry{io}
{
  ...
  description={
      ...
      Auf Ebene der Computerarchitektur wird allgemein jegliche Übertragung von Informationen (unabhängig von der Richtung) von einer CPU ausgeführt, indem
...
\newglossaryentry{servlet-container}{
  ...
  description={
      ...
      Servlets sind Java-Klassen, deren Bytecode dynamisch vom Anwendungsserver geladen und ausgeführt werden können.
      Sie interagieren mit Web-Clients durch ein Request/Response Paradigma welches vom Servlet-Container implementiert wird, beispielsweise
      das Thread-per-request Modell\parencite{JakartaServlet}}
}
...
\newglossaryentry{uber-jar}{
  name=uber-JAR,
  description={
      Ein uber-JAR, auch als \textit{fat JAR} bezeichnet, ist eine Java-Archiv das sowohl alle Klassen des Projektes, als auch alle Klassen der
      Abhängigkeiten enthält. Dadurch kann das Programm als einzige .jar-Datei deployed und auf einer JVM ausgeführt werden}
}
...
\newglossaryentry{spag}{
  ...
  description={
      ...
      In einer SPA findet nie eine Seitenaktualisierung seitens des Browsers statt.
      Stattdessen wird der gesamte erforderliche HTML-, JavaScript- und CSS-Code entweder vom Browser
...
\newglossaryentry{jsong}{
  ...
  description={
      ...
      Es wurde mit der Absicht entwickelt für Menschen einfach zu lesen, und für Maschinen einfach zu parsen und generieren zu sein.
      Es basiert dabei auf einer Untermenge der JavaScript Programmiersprache, ist aber als Textformat komplett unabhängig von Programmiersprachen\parencite{JSON}}
}
\newglossaryentry{circuitBreaker}{
  name=Circuit Breaker,
  description={
      Bei dem Circuit Breaker Pattern handelt es sich um ein Verhaltensmuster das an das Konzept einer elektrischen Sicherung
      angelehnt ist. Es wird genutzt um wiederkehrende Verbindungsfehler zu Ressourcen zu entdecken und den Zugriff für eine bestimmte
      Zeit zu blockieren. Darüber hinaus kann es im Fehlerfall spezifische Funktionen einer Anwendung blockieren}
}
