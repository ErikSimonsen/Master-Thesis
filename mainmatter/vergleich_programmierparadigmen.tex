...
(Servlet, JAX-RS) oder weiter auf einem der \textit{IO threads} (Reactive Routes, Reactive Resteasy) ausgeführt.
...
Transfer/sec:      7.93MB
\end{lstlisting}\footnote{Die Resultate der Testreihen sind auch im Quellcodeverzeichnis unter \textit{\/results} zu finden}
