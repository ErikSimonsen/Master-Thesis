...
(daher auch \textit{worker thread} bezeichnet). Sie nutzen das \verb|Thread per Request|-Modell.
...
Solange der ausführende Thread aktiv ist und die Queue noch Events enthält, wird in einer Schleife das nächste Event
abgerufen und an den, für diesen Eventtyp, registrierten Event-Handler weitergeleitet.
\begin{figure}[h!]
	\centering
