...
Im Gegensatz zu \verb|Kernel-Threads| kann einem User-Thread, der einen blockierenden Systemaufruf macht,
...
Sobald die Schedulingstrategie eines Schedulers erfordert das ein gerade rechnender Thread die Kontrolle einer \glsuseri{logische CPU}(*) an
